                ...
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                  <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div class="grid grid-cols-3 gap-6">
                      <div class="col-span-3 sm:col-span-2">
                        <label for="titl_seo" class="block text-lg font-medium text-gray-700">
                          {{__('SEO Title')}} </label>
                        <div class="mt-1 flex rounded-md shadow-sm">
                          <input type="text" name="titl_seo" id="titl_seo" class="focus:ring-[#006f7e] focus:border-[#006f7e] flex-1 block w-full rounded-none rounded-md sm:text-lg border-gray-300" placeholder="{{__('SEO Title')}}" value="{{ $actualite->titl_seo }}">
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div class="mt-1">
                        <textarea id="description_seo" name="description_seo" rows="3" class="px-1.5 py-1.5 shadow-sm focus:ring-[#006f7e] focus:border-[#006f7e] mt-1 block w-full sm:text-lg border border-gray-300 rounded-md" placeholder="{{__('Description of SEO')}}">{{ $actualite->description_seo }}</textarea>
                      </div>
                    </div>

                    <div class="flex items-start">
                      <div class="flex items-center h-5">
                        <input id="active" name="active" type="checkbox" class="focus:ring-[#006f7e] h-4 w-4 text-[#006f7e] border-gray-300 rounded" {{$actualite->active ? 'checked' : '' }}>
                      </div>
