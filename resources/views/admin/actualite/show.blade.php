        ...
        <main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll">
          ...
          <main class="relative container mx-auto bg-white px-4">
            <div class="relative -mx-4 top-0 pt-[17%] overflow-hidden">
              <img class="absolute inset-0 object-cover object-top w-full h-full filter blur" src="{{ asset('/storage/' . $actualite->photo) }}" alt="" />
            </div>

            <div class="mt-[-10%] w-1/2 mx-auto">
              <div class="relative pt-[56.25%] overflow-hidden rounded-2xl">
                <img class="w-full h-full absolute inset-0 object-cover" src="{{ asset('/storage/' . $actualite->photo) }}" alt="" />
              </div>
            </div>
