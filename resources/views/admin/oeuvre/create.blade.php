                  ...
                  <div class="mb-5 px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div class="grid grid-cols-3 gap-6">
                      <div class="col-span-3 sm:col-span-2">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                          <input type="text" name="titre" id="titre" class="focus:ring-[#92d6d6] focus:border-[#92d6d6] flex-1 block w-full rounded-md sm:text-lg border-gray-300" placeholder="{{__('Title of the artwork')}}">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-6">
                      <div class="col-span-3 sm:col-span-2">
                        ...
                        <div class="mt-1 flex rounded-md shadow-sm">
                          <input type="text" name="sous_titre" id="sous_titre" class="focus:ring-[#92d6d6] focus:border-[#92d6d6] flex-1 block w-full rounded-md sm:text-lg border-gray-300" placeholder="{{__('Subtitle of the artwork')}}">
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div class="mt-1">
                        <textarea id="description" name="description" rows="3" class="px-1.5 py-1.5 shadow-sm focus:ring-[#92d6d6] focus:border-[#92d6d6] mt-1 block w-full sm:text-lg border border-gray-300 rounded-md" placeholder="{{__('Description of the artwork')}}"></textarea>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div class="mt-1">
                        <input type="date" name="date" id="date" class="focus:ring-[#92d6d6] focus:border-[#92d6d6] flex-1 block w-full rounded-md sm:text-lg border-gray-300">
                      </div>
                    </div>
