                    ...
                    <div class="grid grid-cols-1 gap-5 mt-6 sm:grid-cols-2 lg:grid-cols-4">
                        <a href="{{ route('admin.actualites.index') }}">
                            <div class="p-4 transition-shadow border rounded-lg shadow-sm hover:shadow-lg">
                                ...
                                <div>
                                    <span class="inline-block px-2 text-sm text-white bg-[#92d6d6] rounded">{{ $actualitesDernierMois->count() }}</span>
                        ...
                        <a href="{{ route('admin.categories.index') }}">
                            <div class="p-4 transition-shadow border rounded-lg shadow-sm hover:shadow-lg">
                                ...
                                <div>
                                    <span class="inline-block px-2 text-sm text-white bg-[#92d6d6] rounded">{{ $categoriesDernierMois->count() }}</span>
                                    <span>le dernier mois</span>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('admin.collections.index') }}">
                            <div class="p-4 transition-shadow border rounded-lg shadow-sm hover:shadow-lg">
                                ...
                                <div>
                                    <span class="inline-block px-2 text-sm text-white bg-[#92d6d6] rounded">{{ $collectionsDernierMois->count() }}</span>
                                    <span>le dernier mois</span>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('admin.oeuvres.index') }}">
                            <div class="p-4 transition-shadow border rounded-lg shadow-sm hover:shadow-lg">
                                ...
                                <div>
                                    <span class="inline-block px-2 text-sm text-white bg-[#92d6d6] rounded">{{ $oeuvresDernierMois->count() }}</span>
                                    <span>le dernier mois</span>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('admin.users.index') }}">
                            <div class="p-4 transition-shadow border rounded-lg shadow-sm hover:shadow-lg">
                                ...
                                <div>
                                    <span class="inline-block px-2 text-sm text-white bg-[#92d6d6] rounded">{{ $usersDernierMois->count() }}</span>
                                    <span>le dernier mois</span>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('admin.contacts.index') }}">
                            <div class="p-4 transition-shadow border rounded-lg shadow-sm hover:shadow-lg">
                                ...
                                <div>
                                    <span class="inline-block px-2 text-sm text-white bg-[#92d6d6] rounded">{{ $contactsMeDernierMois->count() }}</span>
                                    <span>le dernier mois</span>
                                </div>
                            </div>
                        </a>
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                                ...
                                                <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                                    <a href="{{ route('admin.users.edit', $user) }}" class="text-[#92d6d6] hover:text-[#08a398]">Edit</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
