<x-app-layout>
  ...
  <main class="relative container mx-auto bg-white px-4">
    ...
    <article class="max-w-prose mx-auto py-8">
      <h1 class="text-4xl font-bold mb-3">{{ $categorie->titre }}</h1>
      <h2 class="text-2xl font-bold">{{ $categorie->sous_titre }}</h2>

      <p class="mt-6 text-justify">{{ $categorie->description }}</p>
    </article>
  </main>
</x-app-layout>