          ...
          <div class="mt-6">
            <div class="max-w-4xl px-10 py-6 mx-auto bg-white rounded-lg shadow-md">
              <div class="flex items-center justify-between">
                ...
                <a href="#" class="px-2 py-1 font-bold text-gray-100 bg-gray-600 rounded hover:bg-gray-500">{{ $post->collection->title }}</a>
              </div>
              ...
              <div class="flex items-center justify-between mt-4">
                <a href="{{ route('actualites.show', $post) }}" class="text-blue-500 hover:underline">Voir plus</a>
                <div><a href="#" class="flex items-center">
                    @foreach ($photos as $photo)
                    @if ($photo->artwork == $post->artwork)
